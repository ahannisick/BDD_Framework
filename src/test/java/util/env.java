...
/**
 * Created by adam.hannisick
 * -Added FocusNewWindow and ParentWindow
 * -Added WaitforPageLoad
 * -Added Logging for error handling
 * -Added ClickAttempt to handle multiple DOM and StaleElement issues on Page
 * -Added  Universal find search result to loop through Div tables and find matching values
 * -Modified FindSearch to be more robust
 * -Modified ClickAttempt to handle all clicks and added implict waits to function
 *
 */
