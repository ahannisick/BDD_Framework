...
public class ObjectMap {
    ...
    public ObjectMap() {
        ...
        try {
            String filePath = "/Users/ktthemagicman/BDD_Framework/src/test/java/objectrepository/objectmap.properties";
    ...
    public By getLocator (String strElement) throws Exception {
        ...
        if ( locatorType.toLowerCase().equals("id") )
            ...
            throw new Exception("Unknown locator type '" + locatorType + "' not defined!!");
    }
}
